...
export default function Messages() {
  return (
    <div className="flex flex-col items-center  md:mt-[clamp(0px,calc(12.35svh_-_86.42px),40px)]">
      ...
      <p className="text-[#2D3436] max-w-[clamp(650px,100vw,1000px)] mt-5 leading-relaxed text-[clamp(12px,1.2vw+6px,18px)] text-center font-jakarta font-normal">
